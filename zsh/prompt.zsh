...
function __promptline {
  ...
  local x_fg="${wrap}38;5;158${end_wrap}"
  ...
  local z_bg="${wrap}48;5;123${end_wrap}"
  local z_sep_fg="${wrap}38;5;123${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
